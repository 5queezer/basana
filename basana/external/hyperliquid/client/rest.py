...
try:
    ...
    from hyperliquid.info import Info  # type: ignore[import-untyped]  # pragma: no cover
    from hyperliquid.exchange import Exchange as HLExchange  # type: ignore[import-untyped]  # pragma: no cover
except ImportError:
