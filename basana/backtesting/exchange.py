...
class Exchange:
    ...
    async def create_market_order(
        ...
        return await self.create_order(
            requests.MarketOrder(operation, pair, amount, auto_borrow=auto_borrow, auto_repay=auto_repay)
        )
    ...
    async def create_limit_order(
        ...
        """
        return await self.create_order(
            requests.LimitOrder(operation, pair, amount, limit_price, auto_borrow=auto_borrow, auto_repay=auto_repay)
        )
    ...
    async def create_stop_order(
        ...
        * A sell stop order is entered at a stop price below the current market price. Investors generally use a sell
        ...
        """
        return await self.create_order(
            requests.StopOrder(operation, pair, amount, stop_price, auto_borrow=auto_borrow, auto_repay=auto_repay)
        )
